...
import com.algoideas.androidserialport.adapter.HistoryAdapter;
import com.algoideas.androidserialport.adapter.LeftAdapter;
import com.algoideas.androidserialport.adapter.MsgAdapter;
...
public class MainActivity extends AppCompatActivity implements MainContract.IView {
     ...
     * arguments passed in with the {@link #startActivity(Intent)} intent.
     */
    private static UsbSerialPort sUsbSerialPort = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPresenter = new MainPresenter(this, sUsbSerialPort);
    ...
    public void showPermissionDialog() {
        ...
        textView.setText(String.format(Locale.getDefault(), string));
    ...
    public void jumpToGithub(View view) {
        Uri uri = Uri.parse("https://github.com/algoideas/AndroidSerialPort");
